...
class LoginRateLimiter:
    ...
    def __init__(
        ...
        self._max_attempts = max_attempts or MONITOR_RATE_LIMIT_MAX
        self._window_seconds = window_seconds or MONITOR_RATE_LIMIT_WINDOW
        self._lock = asyncio.Lock()
...
def get_user_store() -> UserStore:
    ...
    if _user_store is None:
        _user_store = UserStore(Path(MONITOR_USERS_FILE))
    return _user_store
